...
import { BAR_ADDRESS, ZERO } from '@123swap/core-sdk-v2'
  ...
  return (
    <Container id="bar-page" className="p-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        />
        <meta key="twitter:url" name="twitter:url" content="https://exchange.123swap.finance/stake" />
        ...
        <meta
          ...
          content="Stake 123Swap in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all 123Swap products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://exchange.123swap.finance/xsushi-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE 123Swap" />
        <meta key="og:url" property="og:url" content="https://exchange.123swap.finance/stake" />
        <meta key="og:image" property="og:image" content="https://exchange.123swap.finance/xsushi-sign.png" />
        <meta
          key="og:description"
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between w-full h-24 max-w-xl p-4 rounded md:pl-5 md:pr-7 bg-light-yellow bg-opacity-40">
                <div className="flex flex-col">
                  ...
                  <div className="flex">
                    <a
                      href={`https://analytics.123swap.finance/bar`}
                      target="_blank"
            ...
            <div className="flex flex-col w-full px-4 pt-6 pb-5 rounded bg-dark-900 md:px-8 md:pt-7 md:pb-9 border border-bcolor">
              <div className="flex flex-wrap">
                ...
                <div className="flex flex-col w-full mb-4 mt-7 md:mb-0">
                  ...
                  {account && (
                    <a
                      href={`https://analytics.123swap.finance/users/${account}`}
                      target="_blank"
                      rel="noreferrer noopener"
                      className={`
