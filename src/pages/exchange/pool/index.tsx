import { ChainId, CurrencyAmount, JSBI, NATIVE, Pair } from '@123swap/core-sdk-v2'
...
export default function Pool() {
  ...
  const v2Pairs = useV2Pairs(Exchanges[EXCHANGE.INTERNAL], liquidityTokensWithBalances.map(({ tokens }) => tokens))
  const v2IsLoading =
          ...
          {!account ? (
            ...
            <>
              {/* <div className="flex items-center justify-center">
                  <ExternalLink
                    href={"https://analytics.123swap.finance/user/" + account}
                  >
